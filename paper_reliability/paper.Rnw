...
# load all files in the /cache directory
for (f in list.files("../cache", pattern=".*\\.RData", full.names=TRUE)) {load(f)}
@
...
% 			\midrule
%
%   Relationship satisfaction (RS) & 2 & 14 & 5 & \Sexpr{S1.RS.pings} & 3 & 28 & 5 & \Sexpr{S2.RS3.pings}\\
%   Independence motivation (Ind) & 2 & 14 & 5 & \Sexpr{S1.Ind.pings} & 2 & 28 & 4 & \Sexpr{S2.Ind.pings}\\
%   Power motivation (Pow) & 2 & 14 & 5 & \Sexpr{S1.Pow.pings} & 3 & 28 & 4 & \Sexpr{S2.Pow.pings}\\
%   Agency motivation (A) & 4 & 14 & 5 & \Sexpr{S1.A.pings} & 5 & 28 & 4 & \Sexpr{S2.A.pings}\\
%   Closeness motivation (C) & 4 & 14 & 5 & \Sexpr{S1.C.pings} & 4 & 28 & 4 & \Sexpr{S2.C.pings}\\
%
%
% 		\midrule
% 		\end{tabular}
...
print(xtable(VDC_table[match(theoretically_meaningful, VDC_table$sym), c("source", "comment", "example")]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
@ 
...
print(xtable(VDC_table[match(nuisance, VDC_table$sym), c("source", "comment", "example")]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
print(xtable(VDC_table[match("e", VDC_table$sym), c("source", "comment", "example")]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
@ 
...
<<t1abs, echo=FALSE, results="asis">>=
print(xtable(VDC_table[match(theoretically_meaningful, VDC_table$sym), c(3, 6:15)]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
@ 
...
<<t2abs, echo=FALSE, results="asis">>=
print(xtable(VDC_table[match(nuisance, VDC_table$sym), c(3, 6:15)]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
print(xtable(VDC_table[match("e", VDC_table$sym), c(3, 6:15)]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
@ 
...
<<t1rel, echo=FALSE, results="asis">>=
print(xtable(VDC_table[match(theoretically_meaningful, VDC_table$sym), c(3, 16:25)]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
@ 
...
<<t2rel, echo=FALSE, results="asis">>=
print(xtable(VDC_table[match(nuisance, VDC_table$sym), c(3, 16:25)]), only.contents=TRUE, include.rownames=FALSE, include.colnames=FALSE, hline.after=NULL, comment=FALSE)
@ 
...
\begin{table*}	
 ...
 <<tab.reliability, echo=FALSE, results="asis">>=

 	print(xtable(relTable.avg), 
		only.contents=TRUE,
	...
	\begin{threeparttable}
		...
		\begin{tabular}{ldddddddddd} % d column is defined in the preamble and centers on "."
			...
			<<, echo=FALSE, results="asis">>=
				print(xtable(cbind(cor.personlevel.string, cor.personlevel.disatt.string)), 
					only.contents = TRUE,
			...
			<<, echo=FALSE, results="asis">>=
				print(xtable(cbind(cor.daylevel.string, cor.daylevel.disatt.string)), 
					only.contents = TRUE,
					include.rownames=TRUE,
					include.colnames=FALSE, 
					hline.after=NULL, comment=FALSE
			...
			<<, echo=FALSE, results="asis">>=
				print(xtable(cbind(cor.momentlevel.string, cor.momentlevel.disatt.string)), 
					only.contents = TRUE,
					include.rownames=TRUE,
					include.colnames=FALSE, 
					hline.after=NULL, comment=FALSE
